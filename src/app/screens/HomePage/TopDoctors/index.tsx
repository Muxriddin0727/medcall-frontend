  ...
  return (
    <div className="flex justify-center">
      <div className="mb-24 w-full max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-4 grid-flow-row gap-6 my-6 justify-center mx-auto max-xl:grid-cols-2 max-md:grid-cols-1 lg:grid-cols-4">
          {loading
            ? Array(4)
                .fill(0)
                .map((_, index) => (
                ...
                return (
                  <div key={value._id} className="text-center">
                    ...
                    >
                      ...
                      />
                      <div className="hidden justify-center absolute inset-x-auto bottom-2 gap-4 group-hover:flex">
